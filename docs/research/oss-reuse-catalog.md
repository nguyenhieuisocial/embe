...
| [HL7 FHIR R4 Observation](https://hl7.org/fhir/R4/observation.html) | Định hướng định dạng export/interchange sau này; dữ liệu nội bộ vẫn giữ schema gọn hiện có | Không đưa một FHIR server mới vào stack gia đình |
| [WHO anthro](https://github.com/WorldHealthOrganization/anthro) và [rOpenSci gigs](https://github.com/ropensci/gigs) | Là oracle kiểm chứng biểu đồ tăng trưởng khi triển khai dữ liệu Bé; giữ phép tính chuẩn bên ngoài code Portal | Chưa hiển thị percentile thai nhi/trẻ nếu thiếu giới tính, tuổi chuẩn hóa và bộ tham chiếu đã kiểm chứng |
