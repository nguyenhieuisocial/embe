...
export default function StudioResearchPage() {
  return <main className="page studio-main">
    ...
    <StudioNav />
    <header className="studio-heading"><h1>Nguồn ý tưởng</h1><p>Tham khảo để tạo nội dung riêng cho EmBe.</p></header>
    <Link className="btn btn-primary" href="/studio/kham-pha">Tìm chủ đề</Link>
    <details className="studio-disclosure">
      <summary>Nguồn & phạm vi nghiên cứu</summary>
      <p>Đối chiếu ngày {researchDate}: {researchCoverage.indexed} tiêu đề và liên kết. {researchCoverage.reachedEnd ? 'Đã tới cuối danh sách hiển thị.' : 'Chưa xác nhận cuối danh sách.'} Chưa đọc hết từng ảnh và lời trong các bài.</p>
      <h2 className="studio-research-title">Cách trình bày đáng học</h2>
    ...
    <details className="studio-disclosure">
      <summary>12 hướng nội dung</summary>
    ...
    <details className="studio-disclosure">
      <summary>Công cụ & trạng thái tích hợp</summary>
    ...
    <details className="studio-disclosure">
      <summary>Khám phá: khả năng & giới hạn</summary>
    ...
    <details className="studio-disclosure">
      <summary>Lưu ý về độ tin cậy</summary>
    ...
    <details className="studio-disclosure">
      <summary>Quy trình & quyền sử dụng</summary>
