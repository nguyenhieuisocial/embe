...
- Backup Supabase đọc `supabase-backup.env` (bị Git ignore) với đúng hai khóa:
  `SUPABASE_PROJECT_REF`, `SUPABASE_ACCESS_TOKEN`. CLI tạo thông tin đăng nhập
  cơ sở dữ liệu ngắn hạn nên không lưu mật khẩu Postgres lâu dài.
